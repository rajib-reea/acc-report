| #  | account_id | account_type | total_debits | total_credits | net_balance | transaction_date | description                            | transaction_amount | transaction_type |
|----|------------|--------------|--------------|---------------|-------------|------------------|----------------------------------------|-------------------|------------------|
...
| 9  | 2          | receivables  | 1000.00      | 950.00        | -50.00      |                  |                                        |                   |                  |
...
-- Step 5: Return account balances and individual transactions
SELECT
    ab.account_id,
    ab.account_type,
    ab.total_debits,
